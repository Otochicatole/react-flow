...
import taskStyles from '@/components/styles/nodes/task-node.module.css';
...
export function TaskNode({ data, selected }: BaseNodeProps) {
  ...
  return (
    <div className={`${styles.node} ${taskStyles.taskNode} ${selected ? styles.nodeSelected : ''}`}>
      <div className={executionStyles.mainContent}>
        ...
        <div className={taskStyles.taskBar}><div className={taskStyles.taskProgress}></div></div>
