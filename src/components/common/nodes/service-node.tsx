...
import serviceNodeStyles from '@/components/styles/nodes/service-node.module.css';
...
export function ServiceNode({ data, selected }: BaseNodeProps) {
  ...
  return (
    <div className={`${styles.node} ${serviceNodeStyles.serviceNode} ${selected ? styles.nodeSelected : ''}`}>
