...
import xorGateStyles from '@/components/styles/nodes/xor-gate-node.module.css';
...
export function XorGateNode({ data, selected }: BaseNodeProps) {
  ...
  return (
    <div className={`${styles.node} ${xorGateStyles.xorGateNode} ${selected ? styles.nodeSelected : ''}`}>
      <div className={executionStyles.mainContent}>
        ...
        <div className={xorGateStyles.gateLabel}>XOR</div>
